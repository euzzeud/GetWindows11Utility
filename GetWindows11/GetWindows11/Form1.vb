...
Public Class Form1
    ...
    Public Sub DownloadISOFile()
        Try
            Dim request As System.Net.HttpWebRequest = System.Net.HttpWebRequest.Create("https://drive.google.com/uc?id=1zFxGf-7J3Az0_TA4TKC_QQFJ0G7_L4TS&export=download")
            ...
            wc.DownloadFileAsync(New Uri(sr.ReadToEnd.ToString()), FolderBrowserDialog1.SelectedPath + filename)
            sr.Close()
