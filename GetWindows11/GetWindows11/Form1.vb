...
Public Class Form1
    ...
    Public Sub DownloadISOFile()
        Try
            Dim request As System.Net.HttpWebRequest = System.Net.HttpWebRequest.Create("https://onedrive.live.com/download?cid=8817AC1AC35DBAD5&resid=8817AC1AC35DBAD5%21109&authkey=ANHrXbgfQk-P-X0")
            Dim response As System.Net.HttpWebResponse = request.GetResponse()
            Dim sr As New System.IO.StreamReader(response.GetResponseStream())
            Dim OneDriveSharingURL As String = sr.ReadToEnd()
            AddHandler wc.DownloadProgressChanged, AddressOf ProgChanged
            wc.DownloadFileAsync(New Uri(OneDriveSharingURL), FolderBrowserDialog1.SelectedPath + filename)
            sr.Close()
